...
test_coverage:
	...
	go test -v -race -cover -tags=debug -coverpkg=./... -failfast -coverprofile=./coverage-ci/reload.out -covermode=atomic ./tests/plugins/reload
	...
	go test -v -race -cover -tags=debug -coverpkg=./... -failfast -coverprofile=./coverage-ci/broadcast_plugin.out -covermode=atomic ./tests/plugins/broadcast
	go test -v -race -cover -tags=debug -coverpkg=./... -failfast -coverprofile=./coverage-ci/websockets.out -covermode=atomic ./tests/plugins/websockets
	go test -v -race -cover -tags=debug -coverpkg=./... -failfast -coverprofile=./coverage-ci/http.out -covermode=atomic ./tests/plugins/http
	go test -v -race -cover -tags=debug -coverpkg=./... -failfast -coverprofile=./coverage-ci/grpc_plugin.out -covermode=atomic ./tests/plugins/grpc
	go test -v -race -cover -tags=debug -coverpkg=./... -failfast -coverprofile=./coverage-ci/informer.out -covermode=atomic ./tests/plugins/informer
	go test -v -race -cover -tags=debug -coverpkg=./... -failfast -coverprofile=./coverage-ci/server.out -covermode=atomic ./tests/plugins/server
	go test -v -race -cover -tags=debug -coverpkg=./... -failfast -coverprofile=./coverage-ci/status.out -covermode=atomic ./tests/plugins/status
	go test -v -race -cover -tags=debug -coverpkg=./... -failfast -coverprofile=./coverage-ci/config.out -covermode=atomic ./tests/plugins/config
	go test -v -race -cover -tags=debug -coverpkg=./... -failfast -coverprofile=./coverage-ci/gzip.out -covermode=atomic ./tests/plugins/gzip
	go test -v -race -cover -tags=debug -coverpkg=./... -failfast -coverprofile=./coverage-ci/headers.out -covermode=atomic ./tests/plugins/headers
	go test -v -race -cover -tags=debug -coverpkg=./... -failfast -coverprofile=./coverage-ci/logger.out -covermode=atomic ./tests/plugins/logger
	go test -v -race -cover -tags=debug -coverpkg=./... -failfast -coverprofile=./coverage-ci/metrics.out -covermode=atomic ./tests/plugins/metrics
	go test -v -race -cover -tags=debug -coverpkg=./... -failfast -coverprofile=./coverage-ci/resetter.out -covermode=atomic ./tests/plugins/resetter
	go test -v -race -cover -tags=debug -coverpkg=./... -failfast -coverprofile=./coverage-ci/rpc.out -covermode=atomic ./tests/plugins/rpc
...
test: ## Run application tests
	docker compose -f tests/env/docker-compose.yaml up -d --remove-orphans
	sleep 10
	go test -v -race -failfast -tags=debug ./api/v2/jobs/pipeline
