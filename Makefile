...
test_coverage:
	...
	go test -v -race -cover -tags=debug -coverpkg=./... -coverprofile=./coverage-ci/config_validate.out -covermode=atomic ./config
	...
	go test -v -race -cover -tags=debug -coverpkg=./... -coverprofile=./coverage-ci/tcp_plugin.out -covermode=atomic ./tests/plugins/tcp
...
test: ## Run application tests
	...
	go test -v -race -tags=debug ./config
